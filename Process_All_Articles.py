...
folder_processed='Data/Processed Articles'
folder_path = 'Data/All Articles'
...
for data_file in sorted(os.listdir(folder_path)):
    ...
    my_bigrams = list(nltk.bigrams(tokens_lem))
    my_trigrams = list(nltk.trigrams(tokens_lem))
       
    out_data = {'URL': unicodedata.normalize('NFKD', url).encode('ascii','ignore'),
    'Text': ntext, 'Text_NoPunctuation': text_nopunc, 'Text_Lower': text_lower,
    'Text_NoStopwords':text_nostop, 'Text_Lemmatized': text_lem,
    'Text_Bigrams': my_bigrams,
    'Text_Trigrams': my_trigrams}
